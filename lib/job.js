...
(function() {
  ...
  module.exports = Job = (function() {
    ...
    Job.prototype.publish = function(body, options, cb) {
      ...
      result = this.channel.publish(this.connection.exchange.name, this.type, body, options);
      if (result) {
    ...
    Job.prototype.jobPartFailure = function(message) {
      var base;
      return typeof (base = this.queue).jobPartFailure === "function" ? base.jobPartFailure(message) : void 0;
    };

    Job.prototype.jobFullFailure = function(message) {
      var base;
      return typeof (base = this.queue).jobFullFailure === "function" ? base.jobFullFailure(message) : void 0;
    };

    Job.prototype.jobSuccess = function(message) {
      var base;
      return typeof (base = this.queue).jobSuccess === "function" ? base.jobSuccess(message) : void 0;
    };
    ...
    Job.prototype.process = function(message) {
      ...
      message.ack = (function(_this) {
        return function() {
          return _this.channel.ack(message);
        };
      })(this);
      message.nack = (function(_this) {
        return function() {
